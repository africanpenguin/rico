...
RicoApp.controller('EventsByLocationLocationCtrl', [ '$scope', '$routeParams', '$route', '$rootScope', 'EventsService', '$modal',
		function($scope, $routeParams, $route, $rootScope, EventsService, $modal) {
      $scope.location = $routeParams.location
      $scope.locationEvents = EventsService.getLocationEvents($scope.location)
    }
]);
