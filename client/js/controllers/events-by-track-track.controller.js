...
RicoApp.controller('EventsByTrackTrackCtrl', [ '$scope', '$routeParams', '$route', '$rootScope', 'EventsService', '$modal',
		function($scope, $routeParams, $route, $rootScope, EventsService, $modal) {
      $scope.track = $routeParams.track
      $scope.trackEvents = EventsService.getTrackEvents($scope.track)
    }
]);
